...
describe.each`
	...
	${"true"}              | ${""}                                                            | ${"CHANGELOG.md"}                                   | ${""}                                               | ${"0.1.4"}                  | ${["--check-sequential-release", "--prerelease-files", "CHANGELOG.md", "--release-version", "0.1.4"]}
	${"false"}             | ${""}                                                            | ${"CHANGELOG.adoc package.json"}                    | ${""}                                               | ${"2.0.0+69c1219f"}         | ${["--prerelease-files", "CHANGELOG.adoc", "package.json", "--release-version", "2.0.0+69c1219f"]}
	${"true"}              | ${""}                                                            | ${"    packages/**/package.json\n    CHANGELOG.md"} | ${""}                                               | ${"10.6.0"}                 | ${["--check-sequential-release", "--prerelease-files", "packages/**/package.json", "CHANGELOG.md", "--release-version", "10.6.0"]}
	${"false"}             | ${""}                                                            | ${""}                                               | ${"CHANGELOG.md"}                                   | ${"0.7.6"}                  | ${["--release-files", "CHANGELOG.md", "--release-version", "0.7.6"]}
	${"true"}              | ${""}                                                            | ${""}                                               | ${"CHANGELOG.adoc package.json"}                    | ${"1.5.0-rc.0+203a1747"}    | ${["--check-sequential-release", "--release-files", "CHANGELOG.adoc", "package.json", "--release-version", "1.5.0-rc.0+203a1747"]}
